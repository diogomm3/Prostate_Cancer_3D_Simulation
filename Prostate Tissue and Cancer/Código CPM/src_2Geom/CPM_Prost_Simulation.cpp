...
int main(int argc, char* argv[]) {
	...
	// double vtarget1 = 3118200;
	// double vtarget2 = 795; 
	// double vtarget3 = 340; 
	// double vtarget4 = 3025800; 
	// double vtarget5 = 795;					
	// fs.open("Prostate3DCells2.txt");
	// std::string geom = "SecondGeom";

	// Second type 3D cells geometry large
	...
	double vtarget5 = 795;					
	fs.open("Prostate3DCells2Large.txt");
	std::string geom = "SecondGeomLarge";
	...
	double J05 [6] = {J01[0], JT, JT, JT, JT, 	 JT*0.9}; 		// Tumoral cells adhesion matrix
