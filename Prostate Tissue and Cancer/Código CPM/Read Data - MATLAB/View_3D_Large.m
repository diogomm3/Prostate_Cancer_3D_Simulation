...
fileID = fopen('Simulation_Data/LargeTest_TumorDynamics106.dat','r');
fileEVO = fopen('Simulation_Data/Large_Cell_Number_EVO_106.txt','r');
...
saveas(gcf,'Simulation Graphs Results\Tumor_Dynamics1_Slides', 'pdf')

figure(2)
saveas(gcf,'Simulation Graphs Results\Tumor_Dynamics1_3D_View', 'pdf')
