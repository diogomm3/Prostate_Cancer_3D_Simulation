...
change = 'NormalCells_LambdaV';

type = 'Tumor_Dynamics_NormalCells_LambdaVDecrease';
...
type = 'Tumor_Dynamics_NormalCells_LambdaVIncrease';
...
% legend('lambdaV = 950/1150','lambdaV = 1900/2300 (std)','lambdaV = 2850/3450')
% xlabel('MCS')
% ylabel('CELLS')
