...
change = 'Tumoral_LambdaV_1';

type = 'Tumor_Dynamics_Tumoral_LambdaVDecrease';
...
type = 'Tumor_Dynamics_Tumoral_LambdaVIncrease';
...
legend('lambdaV = 4400','lambdaV = 8800 (std)','lambdaV = 13200')
xlabel('MCS')
ylabel('CELLS')
