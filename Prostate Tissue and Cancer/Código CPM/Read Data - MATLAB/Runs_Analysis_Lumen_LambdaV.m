...
change = 'Lumen_LambdaV';

type = 'Tumor_Dynamics_Lumen_LambdaVDecrease';
...
type = 'Tumor_Dynamics_Lumen_LambdaVIncrease';
...
% legend('lambdaV = 850','lambdaV = 1900 (std)','lambdaV = 2550')
% xlabel('MCS')
% ylabel('CELLS')
