...
int main() {
    ...
    std::ofstream MyFile("PIF_File_Creation\\Prostate3DCellsSmall.txt");                // Create and open the described text file
    std::ofstream NewFile("Prostate3DCellsSmall.txt");
    ...
    */
    ...
    // Define the Lumen
    MyFile << cell << " 1 0 140 0 2 0 15\n";
    NewFile << cell << " 1 0 140 0 2 0 15\n";
    cell++;
    ...
    // Define the Stroma
    MyFile << cell << " 4 168 285 0 2 0 15";
    NewFile << cell << " 4 168 285 0 2 0 15";
    cell++; 
