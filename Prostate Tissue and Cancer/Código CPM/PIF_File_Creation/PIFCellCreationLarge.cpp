...
int main() {
    ...
    std::ofstream MyFile("PIF_File_Creation\\Prostate3DCellsLarge.txt");                // Create and open the described text file
    std::ofstream NewFile("Prostate3DCellsLarge.txt");
    ...
    */
    ...
    // Define the Lumen
    MyFile << cell << " 1 0 140 0 2 0 45\n";
    NewFile << cell << " 1 0 140 0 2 0 45\n";
    cell++;
    ...
    // Define the Stroma
    MyFile << cell << " 4 168 285 0 2 0 45";
    NewFile << cell << " 4 168 285 0 2 0 45";
    cell++; 
