...
int main() {
    ...
    std::ofstream MyFile("PIF_File_Creation\\Prostate3DCells2Large.txt");                // Create and open the described text file
    std::ofstream NewFile("Prostate3DCells2Large.txt");
    ...
    */
    ...
    // Define the Lumen
    MyFile << cell << " 1 0 91 0 2 0 252\n";
    NewFile << cell << " 1 0 91 0 2 0 252\n";
    cell++;
    
    // Define the Luminal Cells
    for (float i = 0; i < 252; i += 4) {
    ...
    // Define the Stroma
    MyFile << cell << " 4 109 200 0 2 0 252";
    NewFile << cell << " 4 109 200 0 2 0 252";
    cell++; 
